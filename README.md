...
1. Download [Sidekick 1.2.1][download_latest]<sup>1</sup>
...
1. Загрузите [Sidekick 1.2.1][download_latest]<sup>1</sup>
...
[download_latest]: https://github.com/mrachinskiy/sidekick/releases/download/v1.2.1-blender3.4.0/sidekick-1_2_1.zip?repository=https://mrachinskiy.github.io/api/v1/extensions.json&blender_version_min=4.2.0
