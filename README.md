...
1. Download [Sidekick 1.0][download_latest].<sup>1</sup>
...
1. Загрузите [Sidekick 1.0][download_latest].<sup>1</sup>
...
[download_latest]: https://github.com/mrachinskiy/sidekick/releases/download/v1.0.0-blender2.90.0/sidekick-1_0_0.zip
